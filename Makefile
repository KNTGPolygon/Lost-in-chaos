...
SOURCES=source/Main.cpp source/Window.cpp source/Draw.cpp source/Game.cpp source/GameTools.cpp source/Props.cpp source/Math.cpp source/Random.cpp source/Resources.cpp source/Menu.cpp source/EntPlayer.cpp source/EntBullet.cpp source/EntEnemy.cpp source/Outfit.cpp source/AI.cpp source/Wave.cpp
OBJDIR=make/$(TARGET)/
